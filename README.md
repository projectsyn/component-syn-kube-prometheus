# Commodore Component: prometheus

This is a [Commodore][commodore] Component for prometheus.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/prometheus).
